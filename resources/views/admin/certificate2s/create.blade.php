...
<form class="form-inline d-flex justify-content-around" action="{{route('certificate2s.store')}}" method="POST">
    @csrf
    ...
    <div class="form-group m-4"><label class="m-1" for="">اسم وليه الامر:</label>
