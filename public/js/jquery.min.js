...
!(function (e, t) {
    ...
    !(function () {
        function e() {
            if (l) {
                (u.style.cssText =
                    "position:absolute;right:-11111px;width:60px;margin-top:1px;padding:0;border:0"),
                    (l.style.cssText =
                ...
                reliableTrDimensions: function () {
                    ...
                    return (
                        null == a &&
                            ...
                            (e.style.cssText =
                                "position:absolute;right:-11111px"),
                            (t.style.height = "1px"),
                            (n.style.height = "9px"),
        ...
        (S.offset = {
            setOffset: function (e, t, n) {
                ...
                "static" === l && (e.style.position = "relative"),
                    ...
                    ("absolute" === l || "fixed" === l) &&
                    -1 < (o + u).indexOf("auto")
                        ? ((a = (r = c.position()).top), (i = r.right))
                        : ((a = parseFloat(o) || 0), (i = parseFloat(u) || 0)),
                    m(t) && (t = t.call(e, n, S.extend({}, s))),
                    null != t.top && (f.top = t.top - s.top + a),
                    null != t.right && (f.right = t.right - s.right + i),
                    "using" in t
                        ? t.using.call(e, f)
                        : ("number" == typeof f.top && (f.top += "px"),
                          "number" == typeof f.right && (f.right += "px"),
                          c.css(f));
            },
        }),
        S.fn.extend({
                ...
                if (this[0]) {
                    ...
                    if ("fixed" === S.css(r, "position"))
                        ...
                        e &&
                            ...
                            (i.right += S.css(e, "borderLeftWidth", !0)));
                    }
                    return {
                        top: t.top - i.top - S.css(r, "marginTop", !0),
                        right: t.right - i.right - S.css(r, "marginLeft", !0),
                    };
                }
            },
